...
class JsonPersisterSpec extends StaminoJsonSpec {
  ...
  val v2CartCreatedPersister: JsonPersister[CartCreatedV2, V2] =
    persister[CartCreatedV2, V2](
      "cart-created",
      from[V1].to[V2](
        _.update(Symbol("cart") / Symbol("items") / * / Symbol("price") ! set[Int](1000)),
      ),
    )
  ...
  val v3CartCreatedPersister: JsonPersister[CartCreatedV3, V3] =
    persister[CartCreatedV3, V3](
      "cart-created",
      from[V1]
        .to[V2](_.update(Symbol("cart") / Symbol("items") / * / Symbol("price") ! set[Int](1000)))
